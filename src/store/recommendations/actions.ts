...
export function fetchAndPopulateGenreSeeds(): ThunkAction<
    void,
    RootState,
    unknown,
    Action<Array<string>>
...
export function fetchSearchItems(
    ...
    return async function (dispatch: any, getState: any) {
        try {
            ...
            return dispatch(searchItems(data.artists.items, data.tracks.items));
        } catch (error) {
            return console.log(error);
        }
    };
...
export function setRecommmendationResults(
    tracks: Array<Track>
): RecommendationActionTypes {
    return {
...
export function fetchRecommendationResults(): ThunkAction<
    void,
    RootState,
    unknown,
    Action<Array<string>>
